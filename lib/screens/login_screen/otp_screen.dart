                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text("Please enter the OTP send to \n${widget.phoneNumber}", style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: Color(0xff207B94)),),
                    ),
                    SizedBox(height: 30,),
                    
                   
                    FractionallySizedBox(widthFactor: 1, child: Column(
